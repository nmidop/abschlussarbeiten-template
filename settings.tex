...
\IfLanguageName{ngerman}{%
        \crefname{listing}{\lstlistingname}{??}
        \Crefname{listing}{\lstlistingname}{??}
}{}
...
\AtBeginDocument{
    ...
    \hypersetup{pdfsubject=\ttype} % Set the PDF's subject to the type of thesis
    \hypersetup{pdfkeywords={}} % Clean the PDF's meta keywords
